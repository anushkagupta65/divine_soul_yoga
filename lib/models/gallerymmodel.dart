class GalleryResponse {
  ...
  factory GalleryResponse.fromJson(Map<String, dynamic> json) {
    return GalleryResponse(
      ...
      data: List<GalleryItem>.from(json['data'].map((item) => GalleryItem.fromJson(item))),
    );
  }
}
...
class GalleryItem {
  ...
  factory GalleryItem.fromJson(Map<String, dynamic> json) {
    return GalleryItem(
      id: json['id'],
      title: json['title'],
      images: List<GalleryImage>.from(json['images'].map((item) => GalleryImage.fromJson(item))),
    );
  }
}
...
class GalleryImage {
  ...
  GalleryImage({required this.id, required this.galleryId, required this.imageUrl});
