...
class _AttendedEventDetailsState extends State<AttendedEventDetails> {
  ...
  void initState() {
    ...
    _remainingTime =
        DateTime.parse(widget.eventData![0].startDatetime.toString())
          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(widget.eventData![0].title.toString(),
                      style:
                          const TextStyle(fontSize: 18, color: Colors.white)),
                  const SizedBox(height: 10),
                  Text(
                      "${formatDate(widget.eventData![0].startDatetime.toString())} to ${formatDate(widget.eventData![0].endDatetime.toString())}",
                      style: TextStyle(fontSize: 12, color: Colors.white)),
                  const SizedBox(height: 10),
                  Text(
                      "${formatTime(widget.eventData![0].startDatetime.toString())} to ${formatTime(widget.eventData![0].endDatetime.toString())}",
                      style: TextStyle(fontSize: 12, color: Colors.white)),
                  const SizedBox(height: 10),
                  Text("$countdown",
                      style:
            ...
            Padding(
              ...
              child: ClipRRect(
                ...
                child: Image.network(
                    'https://divinesoulyoga.in/${widget.eventData![0].image}'),
              ),
            ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Html(
                      data:
                          'Contact Number: ${widget.eventData![0].contactNumber}'),
                ],
              ),
            ),
            const SizedBox(height: 20),
